...
sudo git clone https://git-codecommit.us-east-1.amazonaws.com/v1/repos/accentureRre_Scrapperv2 -b $branch /mntfirm/buildhere/Scrapper
echo "Code downloaded from git"
...
sudo git clone https://git-codecommit.us-east-1.amazonaws.com/v1/repos/accentureRre_AccentureBatch -b $branch /mntfirm/buildhere/accenturebatch
...
sudo git clone https://git-codecommit.us-east-1.amazonaws.com/v1/repos/accentureRre_accenture -b $branch /mntfirm/buildhere/accenture
